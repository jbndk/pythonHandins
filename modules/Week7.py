...
def edc_interaction(municipal):
    ...
    browser.find_element_by_xpath('//*[@id="ContentContentPlaceHolder_MainContentPlaceHolder_ResultSortingAndItemsPerPage_DropDownListItemsPerPage_chosen"]/div/ul/li[4]').click()
...
def show_plot(dataframe, municipal):
    ...
    mid = dataframe.loc[dataframe["Pris"].between(2000001, 5000000, inclusive=True)]['Pris']
